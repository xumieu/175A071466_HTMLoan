    ...
    <div class="ad_logout col-md-3">
        <ul  class="navbar-nav">
          <!-- <a href="login.php" style=" text-decoration: none" > Đăng nhập</a> -->
            <button style="width:100px; margin-left: 70%"> <a href="#" style=" text-decoration: none" > Đăng xuất</a></button>
         </ul>
     </div>
  </div>
...
<div class="table-1">
    ...
    <tbody>
        ...
        <?php
            while ($row = mysqli_fetch_array($q)) {
                ...
                echo "<a href='edit.php?id=".$row['IDCanBo']."'> <i class='fa fa-pencil' aria-hidden='true'></i></a> &nbsp;"; 
                echo "<a href='delete.php?id=".$row['IDCanBo']."'><i class='fa fa-times' aria-hidden='true'></i></a>";
                echo "</td>";
                echo "</tr>";
   ...
   <div class="table-right">
       ...
       <br>
       <div >
           <button><a href="add.php" style="text-decoration: none;" > Thêm giảng viên</a></button>


           <!-- <a href="add.php"> Thêm Giảng viên </a> -->
       </div>
   </div>
</div>
